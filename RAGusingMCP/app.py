...
# server_params = StdioServerParameters("/home/rj0402g/Documents/Learning/Practice/MCP_Server_SetUp/RAGusingMCP/mcp-json.json")
server_params = StdioServerParameters(
    command = "uv",
    args = ["run", "/home/rj0402g/Documents/Learning/Practice/MCP_Server_SetUp/RAGusingMCP/server.py"]
    )
...
model = ChatOllama(model="qwen3.5", base_url="http://localhost:11434/")
